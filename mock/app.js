...
app.get("/webacs/api/v4/data/Devices.json", (req, res) => {
    console.log("CONNECTION for Devices");
    res.send({
        queryResponse: {
            "@rootUrl": "https://localhost:8443/webacs/api/v1/data",
            "@requestUrl": "https : //szier-m8-106.cisco.com/webacs/api/v1/data/Devices/42",
...
app.get("/webacs/api/v1/data/Devices/1.json", (req, res) => {
